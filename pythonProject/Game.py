...
font = pygame.font.Font('type.ttf', 50)
...
frames1 = []
for i in range(9):
    image = pygame.image.load(f'.venv/monster/Monster{i+1}.png')
    frames1.append(image)

frames2 = []
for i in range(4):
    blood = pygame.image.load(f'.venv/blood/blood{i}.png')
    frames2.append(blood)

bg = pygame.image.load('.venv/Image/bg.png')
gunsight = pygame.image.load('.venv/Image/gunsight.png')
score = pygame.image.load('.venv/Image/ScoreBoard.png')
